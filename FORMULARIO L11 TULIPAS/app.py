# App Streamlit para formulario de mantenimiento Línea 11 con hora Chile y conexión a Google Sheets
...
st.set_page_config(
    page_title="Formulario de Mantenimiento Línea 11",
    page_icon="🛠️",
    layout="centered"
)
...
st.markdown(
    ...
    <div style='text-align: center; padding: 12px 10px 4px 10px;'>
        ...
        <h2 style='color:#2E86C1; margin-top:0px; font-size: 1.25rem; font-weight: 600;'>
            LÍNEA 11 · ENCAJONADORA / DESENCAJONADORA
        </h2>
...
with st.container(border=True):
    with st.form("form_mantenimiento", clear_on_submit=True):
        ...
        with col2:
            ...
            tulipa = st.selectbox("Tulipa", TULIPAS)
